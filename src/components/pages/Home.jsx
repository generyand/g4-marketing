...
function Home() {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center md:h-[calc(100svh-8rem)] gap-10 p-4 md:p-16 mx-auto mt-12 md:mt-0 mb-12 text-center sm:text-start md:flex-row max-w-screen-2xl"
    >
      {/* Title */}
