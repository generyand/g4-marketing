...
function Home() {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center gap-10 p-4 mx-auto mt-12 mb-12 text-center sm:text-start sm:flex-row max-w-screen-2xl sm:mt-28"
    >
      {/* Title */}
      <div className="flex-1">
        <div className="mb-4 title-text">
          <span className="text-4xl sm:text-6xl font-regular">What is a</span>
          <h1 className="text-5xl font-bold text-blue-500 dark:text-blue-400 sm:text-8xl">
            Marketing Plan?
          </h1>
        </div>

        <p className="mb-10 sm:mb-16 sm:text-2xl text-neutral-600 dark:text-neutral-300">
