        ...
        <table className="overflow-hidden min-w-full bg-gray-300 border-collapse table-auto">
          <thead>
            <tr className="text-white bg-blue-500">
              <th className="p-2 border-r border-b border-white md:p-4 last:border-r-0">
                Characteristics
              </th>
              <th className="p-2 border-r border-b border-white md:p-4 last:border-r-0">
          ...
          <tbody className="bg-blue-100 dark:text-gray-800">
            <tr>
              <td className="p-2 border-r border-b border-white md:p-4">
                Production and Consumption
              </td>
              <td className="p-2 border-r border-b border-white md:p-4">Not Simultaneous</td>
            ...
            <tr>
              ...
              <td className="p-2 border-r border-b border-white md:p-4">Tangible</td>
