...
const needAndImportanceData = [
  {
    ...
    description:
      "It helps in identifying new market opportunities for existing and new products. It provides information on market share, nature of competition, customer satisfaction levels, sales performances, and distribution channel. This helps the firms in solving problems.",
  },
  {
    title: "Formulating market strategies",
    description:
      "Today, markets are no longer local. They have become global. Manufacturers find it difficult to contact customers and control distribution channels. Competition is equally severe. The consumer needs are difficult to predict. Market segmentation is a complicated task in such wide markets. The marketing intelligence provided through marketing research not only helps in framing but also implementing the market strategies.",
  },
  {
  ...
  },
  {
    ...
    description:
      "In an era of micro- rather than mass-marketing, communication plays a vital role. Marketing research uses promotional research to study media mix, advertising effectiveness, and integrated communication tools. Research on such aspects will help in promoting a company's product in the market effectively.",
  },
  {
    title: "Improving selling activities",
    description:
      "Marketing research is used to analyze and evaluate the performances of a company within a market. It also studies the effectiveness of a sales force. It helps in identifying sales territories. Such information helps the companies in identifying areas of shortcoming in sales. It also examines alternative methods for the distribution of goods.",
  },
  {
    title: "For sales forecasting",
    description:
      "The most challenging task for any production manager is to keep optimum levels of inventory. However, production is undertaken in anticipation of demand. Therefore, a scientific forecast of sales is required. Marketing research helps in sales forecasting by using market share method, salesforce estimate method, and jury method. This can also help in fixing sales quotas and marketing plans.",
  },
  {
    title: "To revitalize brands",
    description:
      "Marketing research is used to study and find out the existing brand position. It finds out the recall value of brands. It explores the possibilities of brand extension or prospects of changing existing brand names. The main purpose of marketing is to strengthen brand equity.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Marketing research plays a vital role in the decision-making processes by supplying relevant, up-to-date, and accurate data to the decision-makers. Managers need up-to-date information to access customer needs and wants, market situations, technological change, and extent of competition.",
  },
];
