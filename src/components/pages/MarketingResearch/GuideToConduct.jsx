...
const GuideToConduct = () => {
  return (
    <SubTopicContainer className="max-w-3xl p-6 mx-auto bg-white rounded-lg shadow-md">
      <SubTopicTitle className="mb-6 text-3xl font-bold text-gray-800">Guide to Conduct Marketing Research</SubTopicTitle>
      <p className="mb-6 leading-relaxed text-gray-700">
        ...
        through <Highlight className="font-semibold text-blue-600">Primary</Highlight> or{" "}
        <Highlight className="font-semibold text-blue-600">Secondary</Highlight> Research methods.
      </p>

      <div className="mb-8">
        <h3 className="mb-2 text-xl font-semibold text-gray-800 md:text-3xl">
          <Highlight className="text-blue-600">Primary Research</Highlight>
        </h3>
      ...
      <div>
        <h3 className="mb-2 text-xl font-semibold text-gray-800 md:text-3xl">
          <Highlight className="text-blue-600">Secondary Research</Highlight>
        </h3>
